      ...
      <div class="flex animate-marquee gap-5">
        {products.map(product => (
          ...
          <a className="block h-full">
            ...
            <img src={product.images} alt={product.name} height={500} width={500}  className="relative h-full w-full object-cover transition duration-300 ease-in-out hover:scale-105"/>
