  ...
  return (
    <main>
      <section className='container mx-auto bg-black m-5 rounded-3xl hover:drop-shadow-xl duration-300 w-2/5 sm:w-4/5 md:4/5 lg:w-1/2 xl:w-1/2 2xl:w-1/3'>
        <h1 className='flex flex-col items-center text-3xl pt-5 select-none text-white'>Log In</h1>
        <form>
          <div className='flex flex-col items-center text-2xl m-2 md:w-full'>
            ...
            <button className='rounded-full bg-blue-600 p-4 m-5 mt-7 hover:drop-shadow-xl hover:bg-gray-600 duration-300 text-white w-1/3'>Sign In</button>
            <p className='text-white'>Don't have an account?</p>
            <button className='rounded-full bg-blue-600 p-4 mb-5 mt-1 hover:drop-shadow-xl hover:bg-gray-600 duration-300 text-white w-1/3'><Link href="/register">Register</Link></button>
          </div>
          <div>
          </div>
        </form>
