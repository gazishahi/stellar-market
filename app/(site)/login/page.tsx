  ...
  return (
    <main>
      ...
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500'></input>
            ...
            <button className='rounded-full bg-black p-4 m-5 mt-7 hover:drop-shadow-xl hover:bg-gray-600 duration-300 text-white w-1/3'>Sign In</button>
            <p className='text-white'>Don't have an account?</p>
            <button className='rounded-full bg-black p-4 mb-5 mt-1 hover:drop-shadow-xl hover:bg-gray-600 duration-300 text-white w-1/3'>Register</button>
          </div>
          <div>
          </div>
        </form>
