      ...
      <section className="lg:grid lg:grid-cols-6 lg:grid-rows-2">
        <div className="lg:col-span-4 lg:row-span-2 m-3">
          <a className="block h-full">
            ...
            <Image src="/Sneakers.png" height={500} width={500} alt="Sneakers" className="relative h-full w-full object-contain transition duration-300 ease-in-out hover:scale-105"/>
        ...
        <div className="lg:col-span-2 lg:row-span-1 m-3">
          <a className="block h-full">
            ...
            <Image src="/Hydroflask.png" height={500} width={500} alt="Hydroflask" className="relative h-full w-full object-contain transition duration-300 ease-in-out hover:scale-105"/>
              <div className="absolute left-0 top-0 w-3/4 text-black dark:text-white">
                <h3 className="inline bg-white box-decoration-clone py-3 pl-5 font-semibold leading-loose shadow-[1.25rem_0_0] shadow-white dark:bg-black dark:shadow-black text-3xl rounded-br-3xl">Hydroflask</h3>
        ...
        <div className="lg:col-span-2 lg:row-span-1 m-3">
          <a className="block h-full">
          <div className="flex h-full w-full items-center justify-center overflow-hidden bg-gray-900 dark:bg-gray-900 relative rounded-3xl">
          <Image src="/Headphones.png" height={500} width={500} alt="Headphones" className="relative h-full w-full object-contain transition duration-300 ease-in-out hover:scale-105"/>
              <div className="absolute left-0 top-0 w-3/4 text-black dark:text-white">
                <h3 className="inline bg-white box-decoration-clone py-3 pl-5 font-semibold leading-loose shadow-[1.25rem_0_0] shadow-white dark:bg-black dark:shadow-black text-3xl rounded-br-3xl">Headphones</h3>
                <p className="w-fit bg-white px-5 py-3 text-sm font-semibold dark:bg-black dark:text-white rounded-br-3xl">$90.00</p>
              </div>
            </div>
          </a>
        </div>
